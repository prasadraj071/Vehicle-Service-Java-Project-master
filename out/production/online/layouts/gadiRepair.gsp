...
<head>
    ...
    <meta name="description" content="Online Services Offered By GadiRepair">
    <meta name="author" content="Swapnil">
    <title>GadiRepair - Home</title>
    <asset:link rel="shortcut icon" href="gadirepair-logo.png" type="image/x-icon"/>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <g:link class="navbar-brand font-weight-bold" style="color: #278ccc; font-size: 30px;" controller="online" action="home" name="home"><g:message
                code="default.application.title" default="Gadi Repair"/></g:link>
...
<footer class="py-4 bg-dark">
    <div class="container">
        <p class="pull-left" style="color: #278ccc;font-size: 30px; margin-top: -1%;">
            <a target="_blank" href="http://www.facebook.com/gadirepair"><i class="fa fa-facebook-square"></i></a>
        </p>
        <p class="pull-left ml-2" style="color: #278ccc;font-size: 30px; margin-top: -1%;">
            <a href="mailto:gadirepair.com@gmail.com"><i class="fa fa-envelope"></i></a>
        </p>
        <p class="m-0 text-center text-white">
            Copyright &copy; GadiRepair 2017
        </p>
    </div>
    <!-- /.container -->
</footer>
