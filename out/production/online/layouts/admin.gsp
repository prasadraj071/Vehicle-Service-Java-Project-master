...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <g:link class="navbar-brand" controller="admin" action="login" name="home"><g:message
                code="admin.application.title" default="Gadi Repair"/></g:link>
...
<footer class="py-3 bg-dark">
    <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; GadiRepair 2017</p>
    </div>
    <!-- /.container -->
</footer>
